...
namespace Jq.Grid.Demo.Models
{
    ...
    public class DataContextInitializer : DropCreateDatabaseIfModelChanges<DataContext>
    {
        ...
        {
            context.InvoiceHeader.Add(new invheader { id = 13, invdate = DateTime.Parse("2007-10-06"), name = "Client 3", amount = 1000, tax = 0, total = 1000 });
            context.InvoiceHeader.Add(new invheader { id = 12, invdate = DateTime.Parse("2007-10-06"), name = "Client 2", amount = 700, tax = 140, total = 840 });
            ...
            context.InvoiceHeader.Add(new invheader { id = 8, invdate = DateTime.Parse("2007-10-06"), name = "Client 3", amount = 200, tax = 0, total = 200 });
